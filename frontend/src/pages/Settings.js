...
export default function Settings() {
  ...
  const [transcriptionConfig, setTranscriptionConfig] = useState({
    mode: 'local-cpu', // local-cpu, local-gpu, replicate
    replicateApiKey: '',
    cpuThreads: 1,
    gpuDevice: 0,
        ...
        if (settingsRes.ok) {
          ...
          if (settings.transcriptionConfig) {
            setTranscriptionConfig(prev => ({
              ...
              replicateApiKey: settings.transcriptionConfig.replicateApiKey || prev.replicateApiKey
            }));
          }
        }
      } catch (error) {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      toastRef.current?.show({
        severity: 'error',
        summary: 'Error',
        detail: 'Failed to save settings: ' + error.message,
        life: 3000
      });
    }
  };
    ...
    <div className="settings-container">
        ...
        <div className="card">
          ...
          <div className="slider-container">
            ...
            <Slider 
              ...
              onChange={(e) => setTranscriptionConfig(prev => ({...prev, cpuThreads: e.value}))} 
              min={1} 
      ...
      <div className="card">
        ...
        <small className="p-text-secondary">
          ...
          For Replicate API, the "medium" model is recommended.
        </small>
      </div>
      ...
      <Dialog 
        ...
        footer={
          <div>
            ...
            <Button label="Save" icon="pi pi-check" onClick={handleApiKeySubmit} />
          </div>
        }
      >
        <div className="field">
